...
export const APP_THEMES: AppTheme[] = [
  ...
  {
    id: 'solar-flare',
    name: 'Solar Flare Royale',
    subtitle: 'Molten Amber & Crimson Rose',
    tagline: 'Volcanic stellar core with molten amber-gold, solar corona flares and deep ruby embers',
    archetype: 'SUPERNOVA 5000K',
    badge: '☀️ SOLAR CORE',
    pattern: 'solar-corona',
    iconName: 'Sun',
    emoji: '🌅',
    isDark: true,
    colors: {
    ...
    cardPreviewBg: 'linear-gradient(135deg, #250b18 0%, #15060d 100%)',
    headerStyle: {
      background: 'linear-gradient(135deg, rgba(37, 11, 24, 0.95), rgba(21, 6, 13, 0.98))',
    ...
    highlights: ['Molten Gold Horizon', 'Corona Solar Radiance', 'Cosmic Flame Accents'],
  },
  {
    id: 'arctic-frost',
